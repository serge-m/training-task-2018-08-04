...
class MiniVGGTransformCropNormTrainOnly(pl.LightningModule):
...
def main(hparams):
    model = MiniVGGTransformCropNormTrainOnly(hparams)
...
if __name__ == '__main__':
    ...
    parser = MiniVGGTransformCropNormTrainOnly.add_model_specific_args(parent_parser)
