...
class MiniVGGTransformCropNormLR2(pl.LightningModule):
...
def main(hparams):
    model = MiniVGGTransformCropNormLR2(hparams)
...
if __name__ == '__main__':
    ...
    parser = MiniVGGTransformCropNormLR2.add_model_specific_args(parent_parser)
