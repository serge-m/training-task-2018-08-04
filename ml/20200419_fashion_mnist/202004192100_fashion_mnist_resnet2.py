...
class ResnetV2(pl.LightningModule):
    ...
    def train_dataloader(self):
        if self.train_dataset is None:
            self.prepare_data()
        return DataLoader(self.train_dataset, batch_size=self.hparams.batch_size_train, num_workers=12)
...
if __name__ == '__main__':
    ...
    parser = ResnetV2.add_model_specific_args(parent_parser)
