...
def test_correct_data():
    ...
    column_names = ['sid', 'id', 'position', 'created_at', 'created_meta', 'updated_at', 'updated_meta', 'meta', 'MeasureId', 'MeasureName', 'MeasureType', 'StratificationLevel', 'StateFips', 'StateName', 'CountyFips', 'CountyName', 'ReportYear', 'Value', 'Unit', 'UnitName', 'DataOrigin', 'MonitorOnly']
    data = [
        ...
        [3, 'CA5C8F9E-7EC2-4E85-A30E-5A35FCFAACFB', 3, 1439356237, '925122', 1439356237, '925122', None, '83',
         ...
         'Monitor Only', '1']]
    insert_data(data, engine, column_names, None)
